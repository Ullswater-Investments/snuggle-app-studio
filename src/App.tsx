              ...
              <AuthProvider>
                <OrganizationProvider>
                  <Routes>
                    ...
                    <Route
                      path="/documento-explicativo-1"
                      element={<DocumentoExplicativo1 />}
                    />
                    <Route
                      path="/documento-explicativo-2"
                      element={<DocumentoExplicativo2 />}
                    />
                    <Route
                      path="/documento-explicativo-3"
                      element={<DocumentoExplicativo3 />}
                    />
                    <Route
                      path="/documento-explicativo-4"
                      element={<DocumentoExplicativo4 />}
                    />
                    <Route
                      path="/documento-explicativo-5"
                      element={<DocumentoExplicativo5 />}
                    />
                    <Route
                      path="/documento-explicativo-6"
                      element={<DocumentoExplicativo6 />}
                    />
                    <Route
                      path="/documento-explicativo-7"
                      element={<DocumentoExplicativo7 />}
                    />
                    <Route
                      path="/documento-explicativo-8"
                      element={<DocumentoExplicativo8 />}
                    />
                    <Route
                      path="/documento-explicativo-9"
                      element={<DocumentoExplicativo9 />}
                    />
                    <Route
                      path="/documento-explicativo-10"
                      element={<DocumentoExplicativo10 />}
                    />
                    <Route
                      path="/documento-explicativo-11"
                      element={<DocumentoExplicativo11 />}
                    />
                    <Route
                      path="/documento-explicativo-12"
                      element={<DocumentoExplicativo12 />}
                    />
                    <Route
                      path="/documento-explicativo-13"
                      element={<DocumentoExplicativo13 />}
                    />
                    <Route
                      path="/documento-explicativo-14"
                      element={<DocumentoExplicativo14 />}
                    />
                    <Route
                      path="/documento-explicativo-15"
                      element={<DocumentoExplicativo15 />}
                    />
                    <Route
                      path="/capacidades-enterprise"
                      element={<CapacidadesEnterprise />}
                    />
                    <Route
                      path="/kit-espacio-datos"
                      element={<KitEspacioDatos />}
                    />
                    <Route
                      path="/contrato-adhesion"
                      element={<ContratoAdhesion />}
                    />
                    <Route
                      path="/condiciones-kit-espacio-datos"
                      element={<CondicionesKitEspacioDatos />}
                    />
                    <Route
                      path="/contrato-kit-espacio-datos"
                      element={<ContratoKitEspacioDatos />}
                    />
                    <Route
                      path="/inscripcion-kit-espacio-datos"
                      element={<KitEspacioDatosInscripcionPage />}
                    />
                    <Route
                      path="/guia-kit-espacio-datos"
                      element={<GuiaKitEspacioDatos />}
                    />
                    <Route
                      path="/propuesta-kit-espacio-datos"
                      element={<PropuestaKitEspacioDatos />}
                    />
                    <Route path="/token-wallet" element={<TokenWallet />} />
                    <Route path="/fundamentos" element={<Fundamentos />} />
                    <Route path="/catalogo-datos" element={<CatalogoDatos />} />
                    <Route
                      path="/flujo-3-actores"
                      element={<Flujo3Actores />}
                    />
                    <Route path="/politicas-odrl" element={<PoliticasOdrl />} />
                    <Route path="/web3-dids" element={<Web3Dids />} />
                    <Route
                      path="/ia-conversacional"
                      element={<IAConversacional />}
                    />
                    <Route
                      path="/conectores-erp"
                      element={<ConectoresErpPage />}
                    />
                    ...
                    <Route
                      path="/recomendaciones-une"
                      element={<RecomendacionesUne />}
                    />
                    <Route
                      path="/libro-de-reglas"
                      element={<LibroDeReglas />}
                    />
                    ...
                    />
                    <Route
                      path="/nodos-sectoriales"
                      element={<SectoralNodesPage />}
                    />
                    <Route
                      path="/nodos/marketplace"
                      element={<MarketplacePage />}
                    />
                    <Route path="/nodos/odrl" element={<OdrlPage />} />
                    <Route
                      path="/nodos/monetizacion"
                      element={<MonetizacionPage />}
                    />
                    <Route
                      path="/nodos/marca-blanca"
                      element={<MarcaBlancaPage />}
                    />
                    <Route
                      path="/nodos/identidad-did"
                      element={<IdentidadDIDPage />}
                    />
                    <Route
                      path="/nodos/smart-contracts"
                      element={<SmartContractsPage />}
                    />
                    <Route
                      path="/nodos/pagos-euroe"
                      element={<PagosEUROePage />}
                    />
                    <Route
                      path="/nodos/conectores-erp"
                      element={<ConectoresERPPage />}
                    />
                    <Route
                      path="/nodos/gobernanza-idsa"
                      element={<GobernanzaIDSAPage />}
                    />
                    <Route
                      path="/nodos/multi-tenant-rls"
                      element={<MultiTenantRLSPage />}
                    />
                    <Route
                      path="/nodos/requisitos"
                      element={<NodeRequirementsPage />}
                    />
                    <Route
                      path="/nodos/tecnologia"
                      element={<NodeTechPage />}
                    />
                    ...
                    />
                    <Route
                      path="/onboarding/request-invite"
                      element={<RequestInvite />}
                    />

                    <Route
                      path="/agile-procurement/login"
                      element={<AgileProcurementLogin />}
                    />
                    <Route
                      path="/agile-procurement"
                      element={
                    ...
                    <Route
                      ...
                      element={<DocsInteractivos />}
                    />

                    {/* Admin export page - public access for marketing downloads */}
                    <Route
                      path="/admin/export-success-cases"
                      element={<ExportSuccessCasesPage />}
                    />

                    {/* Premium Partners */}
                    <Route
                      path="/partners/premium"
                      element={<PremiumPartners />}
                    />
                    <Route
                      path="/partners/premium/:partnerId"
                      element={<PremiumPartnerPage />}
                    />

                    {/* Partner Pages - Dynamic route */}
                    <Route
                      path="/partners/:partnerSlug/login"
                      element={<DynamicPartnerLogin />}
                    />

                    {/* Partner Pages - ITBID specific */}
                    <Route
                      path="/partners/itbid"
                      element={<PartnerItbidLogin />}
                    />
                    <Route
                      path="/partners/itbid/proyecto"
                      element={
                        <ItbidProtectedRoute>
                          <ItbidProyecto />
                        </ItbidProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/itbid/casos-exito"
                      element={
                        <ItbidProtectedRoute>
                          <ItbidCasosExito />
                        </ItbidProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/itbid/whitepaper"
                      element={
                        <ItbidProtectedRoute>
                          <ItbidWhitepaper />
                        </ItbidProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/itbid/doc-tecnico"
                      element={
                        <ItbidProtectedRoute>
                          <ItbidDocTecnico />
                        </ItbidProtectedRoute>
                    ...
                    <Route
                      path="/partners/telenatura-ebt/miembros"
                      element={
                    ...
                    />
                    <Route
                      path="/partners/telenatura-ebt/proyecto"
                      element={
                        <PartnerProtectedRoute partnerSlug="telenatura-ebt">
                          <TeleNaturaProyecto />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/telenatura-ebt/doc-tecnico"
                      element={
                        <PartnerProtectedRoute partnerSlug="telenatura-ebt">
                    ...
                    />
                    <Route
                      path="/partners/telenatura-ebt/whitepaper"
                      element={
                        <PartnerProtectedRoute partnerSlug="telenatura-ebt">
                    ...
                    />
                    <Route
                      path="/partners/telenatura-ebt/presentacion"
                      element={
                        <PartnerProtectedRoute partnerSlug="telenatura-ebt">
                    ...
                    />
                    <Route
                      path="/partners/telenatura-ebt/catalogo"
                      element={
                        <PartnerProtectedRoute partnerSlug="telenatura-ebt">
                          <TeleNaturaCatalogo />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/telenatura-ebt/acuerdo"
                      element={
                        <PartnerProtectedRoute partnerSlug="telenatura-ebt">
                          <TeleNaturaAcuerdo />
                        </PartnerProtectedRoute>
                    ...
                    {/* Partner Pages - AERCE */}
                    <Route
                      path="/partners/aerce/proyecto"
                      element={<AerceProyecto />}
                    />
                    <Route
                      path="/partners/aerce/miembros"
                      element={
                    ...
                    />
                    <Route
                      path="/partners/aerce/doc-tecnico"
                      element={
                        <PartnerProtectedRoute partnerSlug="aerce">
                          <AerceDocTecnico />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/aerce/doc-institucional"
                      element={
                        <Navigate to="/partners/aerce/doc-tecnico" replace />
                      }
                    />
                    <Route
                      path="/partners/aerce/whitepaper"
                      element={
                        <PartnerProtectedRoute partnerSlug="aerce">
                          <AerceWhitepaper />
                        </PartnerProtectedRoute>
                    ...
                    <Route
                      path="/partners/aracea/proyecto"
                      element={<AraceaProyecto />}
                    />
                    <Route
                      path="/partners/aracea/miembros"
                      element={
                    ...
                    <Route
                      path="/partners/valerdata/proyecto"
                      element={<ValerdataProyecto />}
                    />
                    <Route
                      path="/partners/valerdata/miembros"
                      element={
                    ...
                    <Route
                      path="/partners/seres/proyecto"
                      element={<SeresProyecto />}
                    />
                    <Route
                      path="/partners/seres/miembros"
                      element={
                    ...
                    />
                    <Route
                      path="/partners/seres/miembros/casos-uso/nestle"
                      element={
                        <PartnerProtectedRoute partnerSlug="seres">
                          <SeresNestle />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/seres/miembros/casos-uso/coviran"
                      element={
                        <PartnerProtectedRoute partnerSlug="seres">
                          <SeresCovirán />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/seres/miembros/casos-uso/ilunion"
                      element={
                        <PartnerProtectedRoute partnerSlug="seres">
                          <SeresIlunion />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/seres/miembros/casos-uso/siemens-gamesa"
                      element={
                        <PartnerProtectedRoute partnerSlug="seres">
                          <SeresSiemensGamesa />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/seres/miembros/casos-uso/amadeus"
                      element={
                        <PartnerProtectedRoute partnerSlug="seres">
                          <SeresAmadeus />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/seres/miembros/casos-uso/bt"
                      element={
                        <PartnerProtectedRoute partnerSlug="seres">
                          <SeresBT />
                        </PartnerProtectedRoute>
                    ...
                    <Route
                      path="/partners/cdi-agro"
                      element={<CdiAgroLogin />}
                    />
                    <Route
                      path="/partners/cdi-agro/login"
                      element={<CdiAgroLogin />}
                    />
                    <Route
                      path="/partners/cdi-agro/proyecto"
                      element={<CdiAgroProyecto />}
                    />
                    <Route
                      path="/partners/cdi-agro/miembros"
                      element={
                    ...
                    <Route
                      path="/partners/closerstill"
                      element={<CloserStillLogin />}
                    />
                    <Route
                      path="/partners/closerstill/proyecto"
                      element={<CloserStillProyecto />}
                    />
                    <Route
                      path="/partners/closerstill/miembros"
                      element={
                    ...
                    />
                    <Route
                      path="/partners/closerstill/miembros/365"
                      element={
                        <PartnerProtectedRoute partnerSlug="closerstill">
                          <CloserStill365 />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/closerstill/miembros/casos-uso"
                      element={
                        <PartnerProtectedRoute partnerSlug="closerstill">
                          <CloserStillCasosUso />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/closerstill/miembros/innovacion"
                      element={
                        <PartnerProtectedRoute partnerSlug="closerstill">
                    ...
                    />
                    <Route
                      path="/partners/closerstill/miembros/innovacion/:caseId"
                      element={
                        <PartnerProtectedRoute partnerSlug="closerstill">
                    ...
                    />
                    <Route
                      path="/partners/closerstill/miembros/pioneer"
                      element={
                        <PartnerProtectedRoute partnerSlug="closerstill">
                          <CloserStillPioneer />
                        </PartnerProtectedRoute>
                    ...
                    />
                    <Route
                      path="/partners/closerstill/miembros/prismaticos"
                      element={
                        <PartnerProtectedRoute partnerSlug="closerstill">
                    ...
                    {/* Complete profile - protected, no sidebar */}
                    <Route
                    ...
                    >
                      <Route element={<AppLayout />}>
                        ...
                        />
                        <Route
                          path="/catalog/telemetria-flota"
                          element={<TelemetriaFlotaDetail />}
                        />
                        <Route
                          path="/catalog/consumo-electrico-industrial"
                          element={<ConsumoElectricoDetail />}
                        />
                        <Route
                          path="/catalog/historico-meteorologico"
                          element={<HistoricoMeteorologicoDetail />}
                        />
                        <Route
                          path="/catalog/trazabilidad-aceite-oliva"
                          element={<TrazabilidadAceiteDetail />}
                        />
                        <Route
                          path="/catalog/score-crediticio-b2b"
                          element={<ScoreCrediticioDetail />}
                        />
                        <Route
                          path="/catalog/huella-hidrica-agricola"
                          element={<HuellaHidricaDetail />}
                        />
                        <Route
                          path="/catalog/resiliencia-supply-chain"
                          element={<ResilienciaSupplyChainDetail />}
                        />
                        <Route
                          path="/catalog/huella-carbono-automotriz"
                          element={<HuellaCarbonAutomotrizDetail />}
                        />
                        <Route
                          path="/catalog/capacidad-productiva-automotriz"
                          element={<CapacidadProductivaDetail />}
                        />
                        <Route
                          path="/catalog/benchmarking-precios-componentes"
                          element={<BenchmarkingPreciosDetail />}
                        />
                        <Route
                          path="/catalog/telemetria-ia-automotriz"
                          element={<TelemetriaIAAutomotrizDetail />}
                        />
                        <Route
                          path="/catalog/certificaciones-aeronauticas"
                          element={<CertificacionesAeronauticasDetail />}
                        />
                        <Route
                          path="/catalog/combustibles-saf-aviacion"
                          element={<CombustiblesSAFDetail />}
                        />
                        <Route
                          path="/catalog/disponibilidad-mro-aeronautico"
                          element={<DisponibilidadMRODetail />}
                        />
                        <Route
                          path="/catalog/precios-aleaciones-aeronauticas"
                          element={<PreciosAleacionesDetail />}
                        />
                        <Route
                          path="/catalog/tolerancia-termica-aleaciones"
                          element={<ToleranciaTérmicaDetail />}
                        />
                        <Route
                          path="/catalog/proveedores-premium-automotrices"
                          element={<ProveedoresPremiumDetail />}
                        />
                        <Route
                          path="/catalog/energia-limpia-motor-valley"
                          element={<EnergiaLimpiaMotorValleyDetail />}
                        />
                        <Route
                          path="/catalog/produccion-artesanal-automotriz"
                          element={<ProduccionArtesanalDetail />}
                        />
                        <Route
                          path="/catalog/precios-componentes-superdeportivos"
                          element={<PreciosComponentesSuperdeportivosDetail />}
                        />
                        <Route
                          path="/catalog/telemetria-alto-desempeno"
                          element={<TelemetriaAltoDesempenoDetail />}
                        />
                        <Route
                          path="/catalog/certificaciones-semiconductores"
                          element={<CertificacionesSemiconductoresDetail />}
                        />
                        <Route
                          path="/catalog/impacto-ambiental-chips"
                          element={<ImpactoAmbientalChipsDetail />}
                        />
                        <Route
                          path="/catalog/capacidad-sala-limpia"
                          element={<CapacidadSalaLimpiaDetail />}
                        />
                        <Route
                          path="/catalog/precios-componentes-electronicos"
                          element={<PreciosComponentesElectronicosDetail />}
                        />
                        <Route
                          path="/catalog/caracterizacion-nanomateriales"
                          element={<CaracterizacionNanomaterialesDetail />}
                        />
                        <Route
                          path="/catalog/madurez-digital-tic"
                          element={<MadurezDigitalTICDetail />}
                        />
                        <Route
                          path="/catalog/economia-circular-tic"
                          element={<EconomiaCircularTICDetail />}
                        />
                        <Route
                          path="/catalog/capacidad-desarrollo-software"
                          element={<CapacidadDesarrolloSoftwareDetail />}
                        />
                        <Route
                          path="/catalog/scoring-financiero-digital"
                          element={<ScoringFinancieroDigitalDetail />}
                        />
                        <Route
                          path="/catalog/operadores-red-energetica"
                          element={<OperadoresRedEnergeticaDetail />}
                        />
                        <Route
                          path="/catalog/mix-energetico-alemania"
                          element={<MixEnergeticoAlemaniaDetail />}
                        />
                        <Route
                          path="/catalog/flexibilidad-energetica"
                          element={<FlexibilidadEnergeticaDetail />}
                        />
                        <Route
                          path="/catalog/precios-mayoristas-energia"
                          element={<PreciosMayoristasEnergiaDetail />}
                        />
                        <Route
                          path="/catalog/smart-grid-contadores"
                          element={<SmartGridContadoresDetail />}
                        />
                        <Route
                          path="/catalog/empresas-tecnologicas-belgas"
                          element={<EmpresasTecnologicasBelgasDetail />}
                        />
                        {/* Green Procurement Catalog Routes */}
                        <Route
                          path="/catalog/factores-emision-materiales"
                          element={<FactoresEmisionDetail />}
                        />
                        <Route
                          path="/catalog/intensidad-carbono-red"
                          element={<IntensidadCarbonoRedDetail />}
                        />
                        <Route
                          path="/catalog/emisiones-logisticas-modal"
                          element={<EmisionesLogisticasDetail />}
                        />
                        <Route
                          path="/catalog/emisiones-scope3-cloud"
                          element={<EmisionesScope3CloudDetail />}
                        />
                        <Route
                          path="/catalog/precios-materiales-reciclados"
                          element={<PreciosMaterialesRecicladosDetail />}
                        />
                        <Route
                          path="/catalog/inventario-bioplasticos"
                          element={<InventarioBioplasticosDetail />}
                        />
                        <Route
                          path="/catalog/riesgo-hidrico-proveedores"
                          element={<RiesgoHidricoDetail />}
                        />
                        <Route
                          path="/catalog/minerales-conflicto-3tg"
                          element={<MineralesConflictoDetail />}
                        />
                        <Route
                          path="/catalog/registro-ecolabels"
                          element={<RegistroEcolabelsDetail />}
                        />
                        <Route
                          path="/catalog/sustancias-reach-rohs"
                          element={<SustanciasReachRohsDetail />}
                        />
                        <Route
                          path="/catalog/deforestacion-eudr"
                          element={<DeforestacionEudrDetail />}
                        />
                        <Route
                          path="/catalog/epd-construccion"
                          element={<EpdConstruccionDetail />}
                        />
                        <Route
                          path="/catalog/scoring-esg-proveedores"
                          element={<ScoringEsgDetail />}
                        />
                        <Route
                          path="/catalog/violaciones-laborales"
                          element={<ViolacionesLaboralesDetail />}
                        />
                        <Route
                          path="/catalog/indice-reparabilidad"
                          element={<IndiceReparabilidadDetail />}
                        />
                        <Route
                          path="/catalog/diversidad-proveedores"
                          element={<DiversidadProveedoresDetail />}
                        />
                        <Route
                          path="/catalog/garantias-origen-renovable"
                          element={<GarantiasOrigenDetail />}
                        />
                        <Route
                          path="/catalog/tco-vehiculos-ev-ice"
                          element={<TcoVehiculosDetail />}
                        />
                        <Route
                          path="/catalog/creditos-carbono-voluntarios"
                          element={<CreditosCarbonoDetail />}
                        />
                        <Route
                          path="/catalog/eficiencia-maquinaria-industrial"
                          element={<EficienciaMaquinariaDetail />}
                        />
                        {/* Partner Product Detail Routes - GAIA */}
                        <Route
                          path="/catalog/telemetria-industrial-iot"
                          element={<TelemetriaIotDetail />}
                        />
                        {/* Partner Product Detail Routes - FEIQUE */}
                        <Route
                          path="/catalog/cumplimiento-reach-clp"
                          element={<CumplimientoReachDetail />}
                        />
                        <Route
                          path="/catalog/huella-ambiental-quimica"
                          element={<HuellaQuimicaDetail />}
                        />
                        <Route
                          path="/catalog/capacidad-produccion-quimica"
                          element={<CapacidadQuimicaDetail />}
                        />
                        <Route
                          path="/catalog/precios-productos-quimicos"
                          element={<PreciosQuimicosDetail />}
                        />
                        <Route
                          path="/catalog/analisis-laboratorio-quimico"
                          element={<AnalisisLaboratorioDetail />}
                        />
                        {/* Partner Product Detail Routes - Agoria */}
                        <Route
                          path="/catalog/sostenibilidad-industria-belga"
                          element={<SostenibilidadIndustrialDetail />}
                        />
                        <Route
                          path="/catalog/integracion-robotica"
                          element={<IntegracionRoboticaDetail />}
                        />
                        <Route
                          path="/catalog/precios-automatizacion"
                          element={<PreciosAutomatizacionDetail />}
                        />
                        <Route
                          path="/catalog/telemetria-cobots"
                          element={<TelemetriaCobotDetail />}
                        />
                        {/* Partner Product Detail Routes - ANFIA */}
                        <Route
                          path="/catalog/proveedores-automotrices-italianos"
                          element={<ProveedoresAutomotricesItalianosDet />}
                        />
                        <Route
                          path="/catalog/transicion-ev-italia"
                          element={<TransicionEvItaliaDetail />}
                        />
                        <Route
                          path="/catalog/estampacion-fundicion"
                          element={<EstampacionFundicionDetail />}
                        />
                        <Route
                          path="/catalog/precios-recambios-automotrices"
                          element={<PreciosRecambiosDetail />}
                        />
                        <Route
                          path="/catalog/ensayos-seguridad-vehicular"
                          element={<EnsayosSeguridadDetail />}
                        />
                        {/* Partner Product Detail Routes - FNSEA */}
                        <Route
                          path="/catalog/explotaciones-agricolas-francesas"
                          element={<ExplotacionesAgricolasDetail />}
                        />
                        <Route
                          path="/catalog/sostenibilidad-agricola"
                          element={<SostenibilidadAgricolaDetail />}
                        />
                        <Route
                          path="/catalog/capacidad-cosecha"
                          element={<CapacidadCosechaDetail />}
                        />
                        <Route
                          path="/catalog/precios-commodities-agricolas"
                          element={<PreciosCommoditiesDetail />}
                        />
                        <Route
                          path="/catalog/agricultura-precision"
                          element={<AgriculturaPrecisionDetail />}
                        />
                        {/* Partner Product Detail Routes - NEVI */}
                        <Route
                          path="/catalog/profesionales-compras"
                          element={<ProfesionalesComprasDetail />}
                        />
                        <Route
                          path="/catalog/compras-sostenibles"
                          element={<ComprasSosteniblesDetail />}
                        />
                        <Route
                          path="/catalog/proveedores-precualificados"
                          element={<ProveedoresPrecualificadosDetail />}
                        />
                        <Route
                          path="/catalog/analisis-gasto-categoria"
                          element={<AnalisisGastoDetail />}
                        />
                        <Route
                          path="/catalog/riesgo-supply-chain"
                          element={<RiesgoSupplyChainDetail />}
                        />
                        {/* Partner Product Detail Routes - AIP */}
                        <Route
                          path="/catalog/directorio-industrial-portugues"
                          element={<DirectorioIndustrialDetail />}
                        />
                        <Route
                          path="/catalog/sostenibilidad-portugal"
                          element={<SostenibilidadPortugalDetail />}
                        />
                        <Route
                          path="/catalog/fabricacion-subcontratacion"
                          element={<FabricacionSubcontratacionDetail />}
                        />
                        <Route
                          path="/catalog/costes-industriales-portugal"
                          element={<CostesIndustrialesDetail />}
                        />
                        <Route
                          path="/catalog/fabricacion-moldes"
                          element={<FabricacionMoldesDetail />}
                        />
                        {/* Partner Product Detail Routes - Food Valley */}
                        <Route
                          path="/catalog/empresas-agroalimentarias"
                          element={<EmpresasAgroalimentariasDetail />}
                        />
                        <Route
                          path="/catalog/nutricion-sostenible"
                          element={<NutricionSostenibleDetail />}
                        />
                        <Route
                          path="/catalog/procesamiento-alimentario"
                          element={<ProcesamientoAlimentarioDetail />}
                        />
                        <Route
                          path="/catalog/precios-ingredientes"
                          element={<PreciosIngredientesDetail />}
                        />
                        <Route
                          path="/catalog/analisis-sensorial"
                          element={<AnalisisSensorialDetail />}
                        />
                        {/* Partner Product Detail Routes - BioWin */}
                        <Route
                          path="/catalog/empresas-biotecnologicas"
                          element={<EmpresasBiotechDetail />}
                        />
                        <Route
                          path="/catalog/sostenibilidad-farmaceutica"
                          element={<SostenibilidadFarmaDetail />}
                        />
                        <Route
                          path="/catalog/ensayos-clinicos"
                          element={<EnsayosClinicosDetail />}
                        />
                        <Route
                          path="/catalog/precios-apis-farmaceuticos"
                          element={<PreciosApiDetail />}
                        />
                        <Route
                          path="/catalog/genomica-biomarcadores"
                          element={<GenomicaBiomarcadoresDetail />}
                        />
                        {/* Operational routes */}
                        <Route
                          path="/sustainability"
