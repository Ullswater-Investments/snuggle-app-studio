...
import { CatalogoDatosInfographic } from "@/components/catalogo-datos/CatalogoDatosInfographic";
import { CatalogoDatosChatAgent } from "@/components/catalogo-datos/CatalogoDatosChatAgent";
...
const metrics = [
  { key: "categories", value: 20, suffix: "" },
  { key: "cases", value: 47, suffix: "" },
  { key: "formats", value: 5, suffix: "" },
];
      ...
      <section className="py-16 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="container mx-auto px-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-xs font-medium mb-5">
            <Database className="w-3.5 h-3.5" /> {t("badge")}
          </div>
