      ...
      <main className="flex-1">
          ...
          <div className="container relative mx-auto px-4">
            ...
            <div className="text-center mb-8 space-y-3">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                ...
                <Link
                  to="/recomendaciones-une"
                  className="px-2.5 py-1 rounded-full text-[10px] font-semibold border bg-card text-muted-foreground hover:border-primary hover:text-primary transition-colors flex items-center gap-1"
                >
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-[1.2fr_1fr] gap-8 items-start">
              <Card className="shadow-xl border-2 rounded-2xl">
                <CardContent className="pt-6 pb-4">
                  <FederatedHeroChat
                    onProcessingChange={setIsAgentProcessing}
        ...
        <section className="py-12 bg-muted/30">
          <div className="container mx-auto px-4 text-center">
            ...
            <motion.div
              className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4 md:gap-8"
              initial="hidden"
              whileInView="visible"
              ...
              {sectors.map((sector) => (
                ...
                >
                  ...
                  >
                    <div
                      className={cn(
                        "flex flex-col items-center p-4 md:p-5 rounded-2xl transition-all duration-300 border border-border/50 shadow-sm hover:shadow-md hover:-translate-y-1 h-full",
                        sector.bgColor,
                      )}
                    >
        ...
        <section
          id="models"
          className="py-20 bg-gradient-to-b from-background to-slate-50 dark:to-slate-900"
        >
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Button
                asChild
                size="lg"
                className="bg-[hsl(210,100%,20%)] hover:bg-[hsl(210,100%,25%)] text-white"
              >
                <Link to="/une-0087">
        ...
        <section id="features" className="py-20 bg-muted dark:bg-slate-950">
          <div className="container mx-auto px-4">
            ...
            <div className="mt-12 text-center space-y-3">
              <Link
                to="/capacidades-enterprise"
                className="text-primary hover:text-primary/80 font-semibold flex items-center justify-center gap-2 transition-colors underline-offset-4 hover:underline"
              >
                {t("footer.enterpriseCapabilities")} →{" "}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              <div className="mb-4">
                <img
                  src={procuredataTransparentLogo}
                  alt="PROCUREDATA"
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li>
                  <Link
                    to="/kit-espacio-datos"
                    className="hover:text-white transition-colors"
                  >
                    {t("footer.dataSpaceKit")}
                  </Link>
                </li>
                <li>
                  <Link
                    to="/nodos-sectoriales"
                    className="hover:text-white transition-colors flex items-center gap-1.5"
                  >
                    {t("footer.sectoralNode")}
                    <Badge
                      variant="secondary"
                      className="text-[10px] px-1.5 py-0 bg-orange-500/20 text-orange-300 border-orange-500/30"
                    >
                      {t("footer.new")}
                    </Badge>
                  </Link>
