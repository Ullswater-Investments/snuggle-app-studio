...
import { AnalyticsBiInfographic } from "@/components/analytics-bi/AnalyticsBiInfographic";
import { AnalyticsBiChatAgent } from "@/components/analytics-bi/AnalyticsBiChatAgent";
...
const metrics = [
  { key: "tools", value: 5, suffix: "" },
  { key: "realtime", value: 100, suffix: "%" },
      ...
      <section className="py-16 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="container mx-auto px-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-xs font-medium mb-5">
            <BarChart3 className="w-3.5 h-3.5" /> {t("badge")}
          </div>
