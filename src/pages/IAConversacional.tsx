...
import { IAConversacionalInfographic } from "@/components/ia-conversacional/IAConversacionalInfographic";
import { IAConversacionalChatAgent } from "@/components/ia-conversacional/IAConversacionalChatAgent";
...
const metrics = [
  { key: "agents", value: 5, suffix: "" },
  { key: "references", value: 10000, suffix: "+" },
      ...
      <section className="py-16 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="container mx-auto px-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-xs font-medium mb-5">
            <Bot className="w-3.5 h-3.5" /> {t("badge")}
          </div>
