...
const CHAT_URL = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/ia-conversacional-agent`;

export const IAConversacionalChatAgent = () => {
  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    try {
      ...
      recordOperation({ agent: "federated", caseLabel: "IA Conversacional", question: text, tokensConsumed: tokensUsed });
    } catch {
