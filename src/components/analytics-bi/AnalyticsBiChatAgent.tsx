...
import { Send, BarChart3, AlertTriangle } from "lucide-react";
...
const CHAT_URL = `${import.meta.env.VITE_SUPABASE_URL}/functions/v1/analytics-bi-agent`;

export const AnalyticsBiChatAgent = () => {
  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    try {
      ...
      recordOperation({ agent: "federated", caseLabel: "Analytics y BI", question: text, tokensConsumed: tokensUsed });
    } catch {
