...
import { Battery, TrendingUp, Zap, FileText, BrainCircuit, Clock } from 'lucide-react';
      ...
      <div className="lg:col-span-5">
        <Card className="bg-[#020617] border-indigo-500/20 shadow-2xl h-full p-6">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center"><BrainCircuit className="w-5 h-5 text-white" /></div>
