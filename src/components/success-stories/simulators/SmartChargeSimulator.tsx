...
import { Plug, Zap, Users, FileText, BrainCircuit, Clock } from 'lucide-react';
      ...
      <div className="lg:col-span-5">
        <Card className="bg-[#020617] border-teal-500/20 shadow-2xl h-full p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div><h4 className="text-white font-bold">ARIA</h4><p className="text-[10px] text-slate-400">{t('smartCharge.aria.role')}</p></div>
          </div>
