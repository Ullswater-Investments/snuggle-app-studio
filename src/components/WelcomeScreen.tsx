      ...
      <div className="relative z-10 max-w-4xl w-full space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">
            {t("welcome.titlePrefix", "Bienvenido a ")}
            <span className="procuredata-gradient font-bold tracking-tight">
              PROCUREDATA
            </span>
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
            {isDemo
              ...
              : t(
                  "welcome.subtitle",
                  "Para comenzar a operar, necesitas asociar tu cuenta a una entidad legal.",
                )}
          </p>
        </div>
          ...
          <div className="max-w-lg mx-auto space-y-6 mt-12">
            <Alert className="border-amber-500 bg-amber-50 dark:bg-amber-950/20">
              ...
              <AlertDescription className="text-amber-900 dark:text-amber-100">
                En modo demostración, el registro de organizaciones y las
                invitaciones están deshabilitados.
              </AlertDescription>
            </Alert>
            <Button
              variant="brand"
          ...
          <div className="grid md:grid-cols-2 gap-6 mt-12">
            ...
            <Card className="group relative overflow-hidden border-2 border-transparent hover:border-primary/30 transition-all duration-300 hover:shadow-xl cursor-pointer bg-card/80 backdrop-blur-sm">
              ...
              <CardHeader className="relative z-10 pb-2">
                ...
                <CardTitle className="text-2xl font-bold">
                  {t(
                    "welcome.registerOrg.title",
                    "Registrar Nueva Organización",
                  )}
                </CardTitle>
                <CardDescription className="text-base leading-relaxed">
                  {t(
                    "welcome.registerOrg.description",
                    "Soy el representante legal o administrador. Quiero dar de alta mi empresa y verificarla en la red.",
                  )}
                </CardDescription>
              </CardHeader>
            ...
            <Card className="group relative overflow-hidden border-2 border-transparent hover:border-secondary/30 transition-all duration-300 hover:shadow-xl cursor-pointer bg-card/80 backdrop-blur-sm">
              ...
              <CardHeader className="relative z-10 pb-2">
                ...
                <CardTitle className="text-2xl font-bold">
                  {t(
                    "welcome.joinOrg.title",
                    "Solicitar Unirse a una Existente",
                  )}
                </CardTitle>
                <CardDescription className="text-base leading-relaxed">
                  {t(
                    "welcome.joinOrg.description",
                    "Mi empresa ya utiliza ProcureData. Quiero solicitar acceso al administrador.",
                  )}
                </CardDescription>
              </CardHeader>
              <CardContent className="relative z-10 pt-4">
