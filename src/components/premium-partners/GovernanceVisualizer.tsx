      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            {t('governance.title')} <span className="text-violet-400">{t('governance.titleHighlight')}</span>
          </h2>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="flex-1 space-y-6">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-slate-400">{t('governance.intra.control')}</span>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">{t('governance.intra.feature1.title')}</p>
                              <p className="text-slate-400 text-sm">{t('governance.intra.feature1.desc')}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">{t('governance.intra.feature2.title')}</p>
                              <p className="text-slate-400 text-sm">{t('governance.intra.feature2.desc')}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">{t('governance.intra.feature3.title')}</p>
                              <p className="text-slate-400 text-sm">{t('governance.intra.feature3.desc')}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="flex-1 space-y-6">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-slate-400">{t('governance.inter.tech')}</span>
                        </div>
                        ...
                        <div className="space-y-4">
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">{t('governance.inter.feature1.title')}</p>
                              <p className="text-slate-400 text-sm">{t('governance.inter.feature1.desc')}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">{t('governance.inter.feature2.title')}</p>
                              <p className="text-slate-400 text-sm">{t('governance.inter.feature2.desc')}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700">
                            ...
                            <div>
                              <p className="text-white font-medium">{t('governance.inter.feature3.title')}</p>
                              <p className="text-slate-400 text-sm">{t('governance.inter.feature3.desc')}</p>
                            </div>
                          </div>
                        </div>
                      </div>
